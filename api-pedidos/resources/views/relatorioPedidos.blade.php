...
// Chama a função que irá criar as tabelas 'clientes' e 'pedidos'
Cliente::criaTabelas();

$pedidos_clientes = DB::select(
    'SELECT 
    NOME, CIDADE, ESTADO, TELEFONE, VALOR_PEDIDO, VALOR_FRETE, DATA_ENTREGA
    FROM clientes cli
...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <tbody>
        @foreach ($pedidos_clientes as $pc)
            <tr>
                <td> {{ $pc->NOME }} </td>
                <td> {{ $pc->TELEFONE }} </td>
                <td> {{ $pc->ESTADO }} </td>
